...
(fn draw []
  ...
  (draw-rotated-rectangle "fill" game.player.x game.player.y 80 150 game.player.angle)
  (lg.circle "line" _G.cursor.x _G.cursor.y 10)
  (lg.print (string.format "Mouse X: %f Mouse Y: %f" _G.cursor.x _G.cursor.y ))
  (lg.print (string.format "Player X: %f Player Y: %f" game.player.x game.player.y) nil 20)
